...
class getRouting_ResolverService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Config\Loader\LoaderResolver();

        if (isset($container->privates['routing.resolver'])) {
            return $container->privates['routing.resolver'];
        }

        $container->privates['routing.resolver'] = $instance;
        ...
        $instance->addLoader(($container->privates['routing.loader.attribute.services'] ?? $container->load('getRouting_Loader_Attribute_ServicesService')));
