...
class getSecurity_LogoutListener_MainService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Security\Http\Firewall\LogoutListener(($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), $a, $b, ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'app_logout']);

        if (isset($container->privates['security.logout_listener.main'])) {
            return $container->privates['security.logout_listener.main'];
        }

        return $container->privates['security.logout_listener.main'] = $instance;
    }
}
