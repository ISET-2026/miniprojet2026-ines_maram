 ...
 */
class get_ServiceLocator_1PdkbrhService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private '.service_locator.1Pdkbrh' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.1Pdkbrh'])) {
            return $container->privates['.service_locator.1Pdkbrh'];
        }

        return $container->privates['.service_locator.1Pdkbrh'] = $instance;
    }
}
